...
export type AttentionState = "normal" | "needs_input" | "risk" | "waiting_external";

export type Task = { id: string, project_id: string, title: string, description: string | null, status: TaskStatus, attention_state: AttentionState, parent_workspace_id: string | null, shared_task_id: string | null, created_at: string, updated_at: string, };

export type TaskWithAttemptStatus = { has_in_progress_attempt: boolean, last_attempt_failed: boolean, executor: string, id: string, project_id: string, title: string, description: string | null, status: TaskStatus, attention_state: AttentionState, parent_workspace_id: string | null, shared_task_id: string | null, created_at: string, updated_at: string, };
